...
<%
	...
	String username = ""; 
	 if(session.getAttribute("username")!=null){
	    ...
	    Etudiant etud = dao.getEtudiantByUsername(username);
    ...
    <div class="l-navbar" id="nav-bar">
        <nav class="nav">
            <div>
                ...
                <div class="nav_list">
                    <a href="dashbord.jsp" id="prof-link" class="nav_link"> 
                        <img src="../img/dashboard.png" class="img-icon" alt="dashboard icon" style="width: 30px; height: 30px; margin-left: 5%">
                        <span class="nav_name">Dashboard</span> 
                    </a>
                    <a href="etudiantEmplois.jsp?id=<%= etud.getId() %>" id="emplois-link" class="nav_link"> 
                    ...
                    <a href="listeModulesNotes.jsp?id=<%= etud.getId() %>" id="classes-link" class="nav_link"> 
                        <img src="../img/class.png" class="img-icon" alt="classes icon" style="width: 30px; height: 30px; margin-left: 5%">
                        <span class="nav_name">Modules et Notes</span> 
                    </a> 
                </div>
            </div> 

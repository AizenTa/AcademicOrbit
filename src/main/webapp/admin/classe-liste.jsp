        ...
        <% for (Classe classe : classes) { %>
            <tr>
                ...
                <td>
                    ...
                    <a class="delete-link" href="${pageContext.request.contextPath}/Supprimer?id=<%= classe.getId() %>">Supprimer</a>                    
                    <a class="add-link" href="${pageContext.request.contextPath}/Supprimer?id=<%= classe.getId() %>">Voire Classe</a>                                   
                </td>
            </tr>
        <% } %>
    </table>
